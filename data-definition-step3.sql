...
REFERENCES `proj_customers` (`customer_id`) ON CASCADE DELETE,
    ADD CONSTRAINT `proj_customer_salesreps_ibfk2` FOREIGN KEY (`sid`)
REFERENCES `proj_sales_reps` (`salesrep_id`) ON CASCADE DELETE;
...
REFERENCES `proj_products` (`product_id`) ON CASCADE DELETE;
